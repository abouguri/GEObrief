    ...
    <main className="min-h-screen bg-brand-dark text-white">
      ...
      <article className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-white/75 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">Plans and limits</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong className="text-white">Free:</strong> {FREE_BRIEF_LIMIT} briefs per
                calendar month. The counter resets on the first day of each month.
              </li>
              <li>
                <strong className="text-white">Pro ($15/month):</strong> unlimited briefs
                while the subscription is active.
              </li>
              <li>
                <strong className="text-white">Lifetime ($59, one-time):</strong> unlimited
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">Payments and refunds</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">Fair use</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">Ownership</h2>
            <p>
