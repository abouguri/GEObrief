    ...
    <main className="min-h-screen bg-clay-paper text-clay-ink">
      ...
      <article className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-clay-body leading-relaxed">
          <section>
            <h2 className="font-serif text-xl font-semibold text-clay-ink mb-3">What we collect</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong className="text-clay-ink">Account data:</strong> your email address,
              ...
              <li>
                <strong className="text-clay-ink">Content you submit:</strong> the keywords,
                website URLs, and niche descriptions you enter to generate briefs.
              </li>
              <li>
                <strong className="text-clay-ink">Generated briefs:</strong> the briefs
                produced for you, stored so they appear in your history.
              </li>
              <li>
                <strong className="text-clay-ink">Usage counts:</strong> how many briefs you
                have generated in the current month, used to enforce plan limits.
              </li>
              <li>
                <strong className="text-clay-ink">Purchase records:</strong> if you buy a
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong className="text-clay-ink">Supabase</strong> — database and
                authentication. Stores your account, briefs, and usage records.
              </li>
              <li>
                <strong className="text-clay-ink">Groq</strong> — brief generation. The
              ...
              <li>
                <strong className="text-clay-ink">Gumroad</strong> — payment processing.
                Gumroad handles the transaction and sends us the purchase email and plan
                status.
              </li>
              <li>
                <strong className="text-clay-ink">Vercel</strong> — hosting. Processes
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-clay-ink mb-3">How we use it</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-clay-ink mb-3">Retention and deletion</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-xl font-semibold text-clay-ink mb-3">Your rights</h2>
            <p>
